...
var _user$project$Main$SetSecretNumber = function (a) {
	return {ctor: 'SetSecretNumber', _0: a};
};
var _user$project$Main$generateSecretNumber = A2(
	_elm_lang$core$Random$generate,
	_user$project$Main$SetSecretNumber,
	A2(_elm_lang$core$Random$int, 1, 10));
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: A5(_user$project$Main$Model, 1, '', 0, false, ''),
	_1: _user$project$Main$generateSecretNumber
};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('I am thinking of a number...')
					])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Between 1 and 10')
					])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Your guess: ')
					])),
				A2(
				_elm_lang$html$Html$input,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$value(model.playerGuess),
						_elm_lang$html$Html_Attributes$placeholder('Goes here'),
						_elm_lang$html$Html_Attributes$type$('number'),
						_elm_lang$html$Html_Events$onInput(_user$project$Main$PlayerGuess)
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_user$project$Main$ResetGame)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						A2(
							...
							'Number of guesses: ',
							_elm_lang$core$Basics$toString(model.guessCounter)))
					]))
			]));
};
